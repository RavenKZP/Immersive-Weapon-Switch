...
namespace IconFont
{
	...
	private:
        ...
        //std::string fontName{R"(Data\SKSE\Plugins\fonts\fa-brands-400.ttf)"};
        //std::string fontName{R"(Data\SKSE\Plugins\fonts\fa-regular-400.ttf)"};
		std::string fontName{ R"(Data\Interface\ImGuiIcons\Fonts\fa-solid-900.ttf)" };
		float       fontSize{0.f};
		float       iconSize{0.f};
...
namespace ImGui
{
	...
	void DrawCircle(ImDrawList* drawList, ImVec2 a_center, float a_radius, float progress);
