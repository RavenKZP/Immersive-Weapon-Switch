...
namespace ImGui
{
	...
	void AlignForWidth(const float width, const float alignment)
	{
	...
	void AlignedImage(const ImTextureID texID, const ImVec2& texture_size, const ImVec2& min, const ImVec2& max, const ImVec2& align, const ImU32 colour)
	{
	...
	void CenteredText(const char* label, const bool vertical)
	{
